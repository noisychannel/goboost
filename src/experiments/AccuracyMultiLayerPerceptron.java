...
public class AccuracyMultiLayerPerceptron {
	...
	public static void main(String[] args) {
		String outputFileTrain = "/Applications/MAMP/htdocs/goboost/res/weka/experiments/raw-results/mlp/iteraccuracy33";
		String outputFileTest = "/Applications/MAMP/htdocs/goboost/res/weka/experiments/raw-results/mlp/iteraccuracyTest33";
	...
	private static void runClassifier(String trainFile, String testFile,
		...
		try {
			...
			baseClassifier.setHiddenLayers("a");
